...
export class ProfileComponent implements OnInit {
  ...
  constructor(public EProService: EmpProfileService, public stService: StudentService, public studentloginservice: StudentloginserviceService, private router: Router) { }
